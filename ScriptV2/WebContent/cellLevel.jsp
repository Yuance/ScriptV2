...
<body>
    ...
    <div id="main">
        ...
        <div id="nav">
            ...
            <button class="nav" onclick="next()">Proceed To Template Update</button>
        </div>
...
//    console.log(deleteValue.length);
    //html code for a set
      html = 
            ...
            +'    </div>'
            +'    <div class="footer">'
            +'        <input class="addbutton fl-l" type="button" value="Add Scenario Value">'
            +'        <input class="delvalbutton fl-l" type="button" value="Delete Scenario Value">'
    ...
    function load(){
	    ...
	    xml.open("GET", "RuleFiles/cellLevelRule.json?cb=" + Date.now(), true);
    ...
    function saveconfig(){
        ...
        $.ajax({
            type:"post",
            url:"saveJsonServlet",
            data:{"setting": param.setting, "location": "cell"},
            beforeSend:function(){},
            success:function(data){
            	console.log(data);
            	if (data === "success")
...
/*                 div.className = "value fl-l"; */
                ...
                newValue.innerHTML = '<p>Scenario '+(len - 1)+'</p><input type="text">';
        ...
        remove.addEventListener('click', function(){
                ...
                let len = body.childElementCount;
                if (len<3) alert('No determinant value already!');
                else {
    ...
    function loadSetting(json){
        ...
        for (i=0; i<len; i++) {
            ...
            for (j=0; j<len; j++) {
                ...
                if (j === 0) curvalue = tag.nextElementSibling;
                else curvalue = curvalue.nextElementSibling;
